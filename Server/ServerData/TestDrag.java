...
public class TestDrag {
    ...
    public class TestPane extends JLayeredPane {
        ...
        public TestPane() {
            File[] images = new File("D:\\prog\\Java projects\\UNO game\\src").listFiles(new FileFilter() {
                @Override
            ...
            for (File imgFile : images) {
                ...
                try {
                	...
                	// the following 5 lines should be done inside the card class
                	// JLabel and img should be called as methods of the card classes
